...
export default function FooterNew() {
	...
	const LogoIcon = FiIcons[footer.logo];
					...
					<div className="grid lg:grid-cols-4 gap-12">
						...
						<div className="lg:col-span-1 space-y-8">
							...
							<div className="flex items-center gap-3">
								...
								<span className="text-white text-xl font-semibold">{footer.companyName}</span>
							</div>
							...
							<div className="space-y-2">
								<h3 className="text-2xl lg:text-3xl font-bold text-white leading-tight">
									{footer.branding.heading.prefix}{" "}
							...
							<div className="flex items-center gap-2 text-white/80 hover:text-white transition-colors duration-200 cursor-pointer group">
								<span className="text-sm font-medium">{footer.branding.connect}</span>
							...
							<div className="grid sm:grid-cols-3 gap-8">
								...
								<div className="space-y-4">
									...
									<ul className="space-y-3">
										{footer.navigation.services.map((service, index) => (
											<li key={index}>
								...
								<div className="space-y-4">
									...
									<ul className="space-y-3">
										{footer.navigation.support.map((item, index) => (
											<li key={index}>
												<a href="#" className="text-white/70 hover:text-white transition-colors duration-200">
													{item}
												</a>
